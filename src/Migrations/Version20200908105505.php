 ...
 */
final class Version20200908105505 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE organization ADD org_wallet INT DEFAULT NULL');
        $this->addSql('ALTER TABLE roles ADD amount INT DEFAULT NULL, CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE address address VARCHAR(255) DEFAULT NULL, CHANGE phone phone VARCHAR(255) DEFAULT NULL, CHANGE basic_salary basic_salary INT DEFAULT NULL, CHANGE days_holiday_total days_holiday_total INT DEFAULT NULL, CHANGE days_holiday_remaining days_holiday_remaining INT DEFAULT NULL, CHANGE start_date start_date DATE DEFAULT NULL, CHANGE end_date end_date DATE DEFAULT NULL, CHANGE image_name image_name VARCHAR(255) DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
