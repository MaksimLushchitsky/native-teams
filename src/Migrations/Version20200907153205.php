 ...
 */
final class Version20200907153205 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE agreement CHANGE updated_at updated_at DATETIME DEFAULT \'NULL\', CHANGE agreement_name agreement_name VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT \'NULL\' COLLATE `utf8mb4_unicode_ci`');
